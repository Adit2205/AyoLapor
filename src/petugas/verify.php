...
if (isset($_POST['submit'])) {
    ...
    $update_status = mysqli_query($conn, "UPDATE pengaduan SET status = 'verify' WHERE id_pengaduan = $id_pengaduan");
            ...
            <form action="" method="POST">
                <?php while ($row = mysqli_fetch_assoc($verify)) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?= $row['tgl_pengaduan']; ?>" name="tgl_pengaduan" readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">No Telepon</label>
                        <input type="number" class="form-control" id="exampleInputPassword1" value="<?= $row['telp']; ?>" name="telp" readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Isi laporan</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" value="<?= $row['isi_laporan']; ?>" name="isi_laporan" readonly>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Lokasi</label>
                        <input type="text" class="form-control" id="lokasi" value="<?= $row['lokasi']; ?>" name="lokasi" readonly>
                    </div>
