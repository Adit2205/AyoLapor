...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($result) === 1) {
    ...
    // Simpan informasi tambahan dalam sesi
    $_SESSION['nama_petugas'] = $row['nama_petugas'];
    $_SESSION['level'] = $row['level'];
    $_SESSION['id_petugas'] = $row['id_petugas']; // tambahkan session untuk id petugas
    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-6">
          ...
          <div class="mt-4">
            <a href="../user/login.php" class="btn btn-outline-primary col-12" style="border-radius:20px;">Masuk sebagai Pengguna</a>
          </div>
        </div>
        <div class="col-6">
          <div class="image">
