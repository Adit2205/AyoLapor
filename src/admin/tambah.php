    ...
    <div class="col-6">
      <form action="" method="POST">
        <div class="form-group">
          ...
          <input type="text" class="form-control py-4 shadow-sm" placeholder="Nama Petugas" style="border-radius: 25px;" name="nama_petugas" id="nama_petugas">
        </div>
        <div class="form-group">
          <label for="username">Username</label>
          <input type="text" class="form-control py-4 shadow-sm" placeholder="Username" style="border-radius: 25px;" name="username" id="username">
        </div>
        <div class="form-group">
          <label for="password">Password</label>
          <input type="password" class="form-control py-4 shadow-sm" placeholder="Password" style="border-radius: 25px;" name="password" id="password">
        </div>
        <div class="form-group">
          <label for="telpon">No Telepon</label>
          <input type="number" class="form-control py-4 shadow-sm" placeholder="No telepon" style="border-radius: 25px;" name="telpon" id="telpon">
        </div>
        <div class="form-group">
